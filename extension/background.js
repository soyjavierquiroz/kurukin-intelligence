...
const autoCommand=value=>!!value&&typeof value==='object'&&['KURUKIN_AUTO_QUEUE','KURUKIN_AUTO_PAUSE','KURUKIN_AUTO_RESUME','KURUKIN_AUTO_STOP','KURUKIN_AUTO_SKIP','KURUKIN_AUTO_GET'].includes(value.type);
