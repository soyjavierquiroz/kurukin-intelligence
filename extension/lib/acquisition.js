...
(function(root){
  ...
  const nextBatch=(runtime,analysisId,discoveryComplete=false,hasMore=false)=>call(runtime,'KURUKIN_BACKEND_NEXT_BATCH',{analysisId,discoveryComplete:discoveryComplete===true,hasMore:hasMore===true});
