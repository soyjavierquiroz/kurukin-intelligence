...
(function(root){
  ...
  async function upload(fetcher,message,{BlobCtor=Blob,now=Date.now,onTransferred=()=>{},onRelease=()=>{}}={}){
    ...
    try{
      ...
      handoffMs=now()-handoffStarted;onTransferred();const uploadStarted=now();
